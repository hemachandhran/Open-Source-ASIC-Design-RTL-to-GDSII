# RTL-to-GDS Implementation and Gate-Level Verification of the Housekeeping SPI Block

This report documents the complete implementation flow of the **Housekeeping SPI** module from the VSDSquadron SoC, starting from RTL analysis and progressing through synthesis, floorplanning, placement, clock tree synthesis, routing, and final GDS generation using the OpenROAD Flow.

It also covers the verification of the generated gate-level netlist through both RTL and Gate-Level Simulation (GLS), waveform analysis, debugging process, and comparison of RTL and GLS results to confirm that the implemented design preserves the original functionality.
...
The generated 6_final.v netlist from the OpenROAD flow was used for Gate-Level Simulation.
...
<p align="center">
<img src="Screenshots/18.jpg" width="90%">
</p>
...
This exercise gave me hands-on experience with the complete RTL-to-GDS flow without following a step-by-step guide. I learned how to study an RTL module, identify its dependencies, prepare the OpenROAD setup, and successfully generate the final physical implementation.
